window.QUIZ_DATA = {
    ...
    fib_with_Simple: {
        backgroundImage: "NULL",
        title: "Rewrite the sentences using correct words.",
        wordBox: ["She", "He", "it", "i"],

        questions: [
            {
                id: 1,
                original: "Shalini walks to the park.",
                after: "walks to the park.",
                answer: "She"
            },
            {
                id: 2,
                original: "Jatin writes in his notebook.",
                after: "writes in his notebook.",
                answer: "He"
            },
            {
                id: 3,
                original: "The tree is in the park. The tree is big and green.",
                after: "is big and green.",
                answer: "it"
            },
            {
                id: 4,
                original: "My name is Tarun. Tarun likes chocolate cake.",
                after: "likes chocolate cake.",
                answer: "i"
            }
        ]
    },
