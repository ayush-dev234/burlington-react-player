window.QUIZ_DATA = {
    ...
    mcq_with_options: {
        ...
        questions: [
            {
                question: "Pia has ... hair.",
                options: ["curly", "wooden"],
                correctIndex: 0
            },
            {
                question: "That is a ... chapati.",
                options: ["round", "wet"],
                correctIndex: 0
            },
            {
                question: "There are ... flowers in my garden.",
                options: ["one", "pink"],
                correctIndex: 1
            },
            {
                question: "Look at the lion. It looks ... .",
                options: ["dangerous", "round"],
                correctIndex: 0
            },
            {
                question: "Mum drinks ... coffee.",
                options: ["silver", "hot"],
                correctIndex: 1
            },
            {
                question: "The pillow is ... . It is not hard.",
                options: ["dry", "soft"],
                correctIndex: 1
            },
            {
            ...
            {
                question: "The ground is muddy. My shoes are ... .",
                options: ["dirty", "warm"],
                correctIndex: 0
            },
            {
                question: "Please put the ... towel to dry.",
                options: ["straight", "wet"],
                correctIndex: 1
            },
            {
                question: "Gauri has ... brothers.",
                options: ["one", "two"],
                correctIndex: 1
            }
        ]
