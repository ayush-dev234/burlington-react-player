window.QUIZ_DATA = {
    ...
    fib_with_Simple: {
        title: "Write.",
        wordBox: ["wind", "leaves", "passing", "trees", "heads"],

        question: {
            text: `
Who has seen the __________ ?
Neither I nor you.
But when the __________ hang trembling,
The wind is __________ through.
Who has seen the wind?
Neither you nor I.
But when the __________ bow down their __________,
The wind is passing by.
`,
            answers: ["wind", "leaves", "passing", "trees", "heads"]
        }
    },
    fib_alphabet: {
