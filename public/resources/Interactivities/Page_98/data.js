window.QUIZ_DATA = {
    title: "A. Choose the correct answer.",
    type: "mcq-sentence-slash",
    ...
    fib_with_Simple: {
        backgroundImage: "NULL",
        title: "Write.",
        wordBox: ["three", "two", "green", "yellow", "small", "one"],

        questions: [
            {
                id: 1,
                original: "This is a balcony. It has (1) __________ chairs.",
                after: "",
                answer: "two"
            },
            {
                id: 2,
                original: "The chairs have (2) __________ cushions.",
                after: "",
                answer: "yellow"
            },
            {
                id: 3,
                original: "There is (3) __________ table in the centre.",
                after: "",
                answer: "one"
            },
            {
                id: 4,
                original: "There are (4) __________ bulbs.",
                after: "",
                answer: "three"
            },
            {
                id: 5,
                original: "There are big and (5) __________ plants.",
                after: "",
                answer: "small"
            },
            {
                id: 6,
                original: "All plants have (6) __________ leaves.",
                after: "",
                answer: "green"
            }
        ]
    ...
    mcq_with_options: {
        ...
        questions: [
            {
                question: "What do the lines “Who has seen the wind? / Neither I nor you.” mean?",
                options: [
                    "No one can see the wind.",
                    "Everyone can see the wind."
                ],
                correctIndex: 0
            },
            {
                question: "What is happening when the leaves are trembling?",
                options: [
                    "The sun is shining.",
            ...
            {
                question: "What is happening when the trees bow down their heads?",
                options: [
            ...
            {
                question: "What does the word ‘trembling’ in the line “But when the leaves hang trembling,” mean?",
                options: [
            ...
            {
                question: "Has the poet seen the wind?",
                options: [
                    "Yes",
                    "No"
                ],
    ...
    mcq_sentence_slash: {
        title: "A. Read the statements. Select True or False.",
        questions: [
            {
                id: 1,
                text: "Tarun is sad because he gets a new bag.",
                options: ["True", "False"],
                correctIndex: 1    // False
            },
            {
                id: 2,
                text: "Tarun's new bag is bright blue with a smiling dinosaur on it.  ",
                options: ["True", "False"],
                correctIndex: 0    // True
            },
            {
                id: 3,
                text: "During recess, Tarun finds his juice box has leaked inside his bag. ",
                options: ["True", "False"],
                correctIndex: 0    // True
            },
            {
                id: 4,
                text: "Tarun uses an old cloth to clean his bag. ",
                options: ["True", "False"],
                correctIndex: 0    // True
            },
            {
                id: 5,
                text: "Tarun decides to be more careful with his juice next time. ",
                options: ["True", "False"],
                correctIndex: 0    // True
            }
        ]
