          ...
          >
              ...
              {showToc && (
                ...
                >
                  <ul className="space-y-1 px-1">
                    {tocEntries?.toc?.map((entry, index) => {
                      ...
                      return (
                        <li key={`${entry.page}-${index}`}>
                          <button
                            ...
                            className={`flex w-full justify-between py-2 pr-6 text-left rounded-md transition
            ...
            <AnimatePresence>
              {showVideoToc && (
                ...
                >
                  <ul className="space-y-1 px-1">
                    {tocEntries?.mediaToc?.map((entry, index) => {
                      const isActive = currentPage === entry.page;
                      const isUnit = entry.isUnitHeader;
             ...
             <button
                ...
                className="flex w-full items-center justify-between rounded-md bg-surface-bright px-3 py-2 text-sm font-medium hover:bg-surface"
              >
                <span>🧩 Table of Interactivities</span>
            ...
            <AnimatePresence>
              {showInteractivesToc && (
                ...
                >
                  <ul className="space-y-1 px-1">
                    {tocEntries?.interactiveToc?.map((entry, index) => {
                      const isActive = currentPage === entry.page;
                      const isUnit = entry.isUnitHeader;
